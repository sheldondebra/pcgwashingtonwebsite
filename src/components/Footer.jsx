      ...
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 md:gap-23">
        <div className="flex flex-col items-start">
          ...
          <div className="flex gap-4 text-white mt-6">
            <FaFacebook className="h-6 w-6 hover:text-blue-300 transition" />
            <FaInstagram className="h-6 w-6 hover:text-blue-300 transition" />
            <FaYoutube className="h-6 w-6 hover:text-blue-300 transition" />
          </div>
        </div>
        <div className="text-white">
          <h1 className="font-bold mb-6 text-lg border-b border-blue-400 pb-2 inline-block">Quick Links</h1>
          <div className="flex flex-col gap-3 text-sm">
            <Link to="/" className="hover:underline transition">Home</Link>
            <Link to="/aboutus" className="hover:underline transition">About us</Link>
            <Link to="/committees" className="hover:underline transition">Committees</Link>
            <Link to="/groups" className="hover:underline transition">Groups</Link>
            <Link to="/congregation" className="hover:underline transition">Congregation</Link>
            <Link to="/contactus" className="hover:underline transition">Contact Us</Link>
            <Link to="/give" className="hover:underline transition">Give / Donate</Link>
          </div>
        </div>
        <div className="text-white">
        ...
        <div className="text-white">
          <h1 className="text-lg font-bold mb-6 border-b border-blue-400 pb-2 inline-block">Get in touch</h1>
          <div className="flex items-start gap-4 mt-4">
            <IoLocationSharp className="h-9 w-9 shrink-0 border border-white text-white rounded-full p-2" />
            <div>
          ...
          <div className="flex items-start gap-4 mt-4">
            <MdOutlineMailOutline className="h-9 w-9 shrink-0 border border-white text-white rounded-full p-2" />
            <div>
          ...
          <div className="flex items-start gap-4 mt-4">
            <FaPhoneAlt className="h-9 w-9 shrink-0 border border-white text-white rounded-full p-2" />
            <div>
